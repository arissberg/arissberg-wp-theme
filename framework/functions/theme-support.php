    ...
    add_theme_support(
      ...
      array(
        array(
          ...
          'slug'  => 'primary',
          'color' => hsl_to_hex( 'default' === get_theme_mod( 'primary_color' ) ? 199 : get_theme_mod( 'primary_color_hue', 199 ), 100, 33 ),
        ),
        array(
          'name'  => __( 'Secondary', 'arissberg' ),
          'slug'  => 'secondary',
          'color' => hsl_to_hex( 'default' === get_theme_mod( 'primary_color' ) ? 199 : get_theme_mod( 'primary_color_hue', 199 ), 100, 23 ),
        ),
        array(
